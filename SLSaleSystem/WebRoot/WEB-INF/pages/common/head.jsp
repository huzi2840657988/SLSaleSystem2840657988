...
<head>
	...
	<!-- The styles -->
	<!-- The styles -->
	<link href="/SLSaleSystem/statics/css/bootstrap-cerulean.css" rel="stylesheet">
	<style type="text/css">
	  body {
		padding-bottom: 40px;
	  }
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/SLSaleSystem/main.html"> <img alt="Charisma Logo" src="/SLSaleSystem/statics/img/logo20.png" /> <span>SL会员商城</span></a>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					...
					<label id="for-is-ajax" class="hidden-tablet" for="is-ajax"><input id="is-ajax" type="checkbox"> Ajax on menu</label>
				 	-->
						<!-- 在js文佳中json 方法动态加在加载（首先从后台使用EL表达式获取）
