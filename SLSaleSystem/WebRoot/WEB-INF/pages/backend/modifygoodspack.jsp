						...
						<ul class="aboutproductsList">
						  	...
						  	<li id="selectgoodslist">
						  		<c:if test="${goodsList != null}">
									...
									<label class="del" rprice="${goods.realPrice}"><img src="/SLSaleSystem/statics/img/cancel-on.png"/></label>
...
<script type="text/javascript" src="/SLSaleSystem/statics/localjs/modifygoodspack.js"></script> 
