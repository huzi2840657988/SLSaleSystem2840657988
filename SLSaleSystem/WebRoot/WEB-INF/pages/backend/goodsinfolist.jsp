...
<div>
	<ul class="breadcrumb">
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SLSaleSystem/backend/goodsinfolist.html?currentpage=1&s_goodsName=${s_goodsName}&s_state=${s_state}" title="首页">首页</a></li>
					  	</c:otherwise>
					  </c:choose>
						
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SLSaleSystem/backend/goodsinfolist.html?currentpage=${num}&s_goodsName=${s_goodsName}&s_state=${s_state}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SLSaleSystem/backend/goodsinfolist.html?currentpage=${num}&s_goodsName=${s_goodsName}&s_state=${s_state}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SLSaleSystem/backend/goodsinfolist.html?currentpage=${page.pageCount}&s_goodsName=${s_goodsName}&s_state=${s_state}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
		...
		<form action="/SLSaleSystem/backend/addgoodsinfo.html" enctype="multipart/form-data" method="post" onsubmit="return addGoodsInfoFunction();">
	...
	<div class="modal hide fade" id="modifyGoodsInfoDiv">
		<form action="/SLSaleSystem/backend/modifygoodsinfo.html" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsInfoFunction();">
			<div class="modal-header">
...
<script type="text/javascript" src="/SLSaleSystem/statics/localjs/goodsinfolist.js"></script> 
