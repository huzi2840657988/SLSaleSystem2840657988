...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			...
			<div class="box-icon">
				<span class="icon32 icon-color icon-add cunstom-setting adduser " />
			</div>
		</div>
 ...
 <form action="/SLSaleSystem/backend/userlist.html" method="post">
	 		...
	 		<form action="/SLSaleSystem/backend/adduser.html" enctype="multipart/form-data" method="post" onsubmit="return addUserFunction();">
				...
				<div class="modal-body">
					...
					<ul class="topul">
						...
						<li><label>用户名：</label> 
							<input id="a_logincode" type="text" name="loginCode" value="" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" >
						 	<span style="color:red;font-weight: bold;">*</span>
						</li>
						<li><label>姓名：</label> 
						...
						<li><label>证件号码：</label> 
							<input id="a_idcard" type="text" name="idCard" value="" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" >
						 	<span style="color:red;font-weight: bold;">*</span>
						</li>
				...
				<div class="modal-footer">
					<a href="javascript:void();" class="btn addusercancel" data-dismiss="modal">取消</a>
	...
	<div class="modal hide fade" id="viewUserDiv">
				...
				<div class="modal-footer">
					<a href="javascript:void(0);" class="btn  viewusercancel" data-dismiss="modal">关闭</a>
				</div>
		</div>
...
<script src="/SLSaleSystem/statics/medire/WdatePicker.js" type="text/javascript"></script>
...
<script src="/SLSaleSystem/statics/localjs/userlist.js"></script>
